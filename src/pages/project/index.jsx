            ...
            <div id="fh5co-about" className="fh5co-content-section container">
                <div className="row m-15">
                    <div className="col-md-10 col-md-offset-1 mb-10 text-justify">
                        ...
                        <p>O Lwandi Surf visa superar as barreiras enfrentadas pelos adolescentes da comunidade. O programa atende às necessidades de saúde mental e física dos participantes, assim como acompanhamento escolar, por meio de aulas de natação, yoga, aulas de surf, rodas de conversa, aulas de inglês, monitoramento escolar e treinamento vocacional. Através do esporte e educação, esperamos desenvolver esses jovens, mostrando novos caminhos e maneiras de surfar a onda da vida.</p>
                    </div>
                </div>
